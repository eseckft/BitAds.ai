...
class Hint:
    ...
    def print_campaign_info(campaign):
        ...
        Hint(Hint.COLOR_CYAN, Const.LOG_TYPE_BITADS, "    --------------------------")
        Hint(Hint.COLOR_CYAN, Const.LOG_TYPE_BITADS, "    ")
        Hint(Hint.COLOR_CYAN, Const.LOG_TYPE_BITADS, "    Campaign unique id: " + campaign['product_unique_id'])
        Hint(Hint.COLOR_CYAN, Const.LOG_TYPE_BITADS, "    Campaign title: " + campaign['product_title'])
        Hint(Hint.COLOR_CYAN, Const.LOG_TYPE_BITADS, "    ")
        Hint(Hint.COLOR_CYAN, Const.LOG_TYPE_BITADS, "    --------------------------")
        Hint(Hint.COLOR_WHITE, Const.LOG_TYPE_BITADS, "Preparation for distribution of the campaign to miners.")